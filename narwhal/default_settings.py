...
TRACKER_PRIVATE            = True # require key for announce
TRACKER_ANNOUNCE_STATS     = True # keep U/D stats on users
TRACKER_ANNOUNCE_INTERVAL  = 300  # seconds
TRACKER_SCRAPE_INTERVAL    = 600  # seconds
TRACKER_MAX_SCRAPE_RESULTS = 1500 # max # of results to return on scrape. only the newest of course.
TRACKER_MAX_MULTI_SCRAPE   = 5    # the maximum number of results to return when scraping multiple hashes
